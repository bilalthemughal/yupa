...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'namespace' => 'admin', 'middleware' => ['auth:admin']], function () {
	...
	Route::get('/changeStatus/travelar/{id}', 'DashboardController@changeStatus')->name('changeStatus');
    Route::post('/addNote/travelar', 'DashboardController@addNote')->name('addNote');
    Route::post('/editNote', 'DashboardController@editNote')->name('editNote');
	//::::::::::::::destination::::::::::::::
    ...
    Route::get('create/trip/{id}', 'PackegeController@addTrip')->name('addTrip');
    Route::post('/createTrip','PackegeController@storeTrip')->name('createTrip');
    Route::get('/addDay/{number}', 'PackegeController@addDay');
    Route::get('/addItinary/{number}', 'PackegeController@addItinary');
	...
	*/
	...
	Route::get('/reject-pack/{id}', 'BookingController@reject_tour')->name('reject-pack');
 ...
 */
	...
	Route::get('/changesStatus/{id}/{value}', 'HotelController@changeStatus')->name('hotel.changeStatus');
...
Route::get('/kit-withpack', 'DashboardController@kit_withpack')->name('kit_withpack');
...
//client requirment to checkout::::::::::::::::::
Route::post('/packege-book-checkout', 'CheckoutController@client_checkout')->name('packege-book-checkout')->middleware('auth');
Route::get('/pack-paymentconfirm', 'CheckoutController@booking_payment')->name('pack_paymentconfirm')->middleware('auth');
...
Route::get('package/checkout', 'CheckoutController@checkout_form')->name('checkout_form')->middleware('auth');
Route::post('package/checkout', 'CheckoutController@checkout_final')->middleware('auth');
