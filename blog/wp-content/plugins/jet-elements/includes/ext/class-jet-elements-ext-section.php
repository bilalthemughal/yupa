...
if ( ! class_exists( 'Jet_Elements_Ext_Section' ) ) {
	...
	class Jet_Elements_Ext_Section {
		...
		public function section_before_render( $obj ) {
			...
			if ( 'section' === $type && isset( $settings['jet_parallax_layout_list'] ) ) {
		...
		public function enqueue_scripts() {
			wp_enqueue_script( 'jet-ease-pack', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/easing/EasePack.min.js', null, null, true );
			wp_enqueue_script( 'jet-tween-max', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.2/TweenMax.min.js', null, null, true );
