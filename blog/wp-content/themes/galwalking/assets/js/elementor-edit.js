( function( $, data ) {
	...
	var galwalkingElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, galwalkingElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, galwalkingElementor.initCb );
		},
	...
	galwalkingElementor.init();

}( jQuery, window.galwalkingEditData ) );
