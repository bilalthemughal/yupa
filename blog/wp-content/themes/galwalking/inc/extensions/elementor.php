...
if ( ! class_exists( 'Galwalking_Elementor' ) ) {

	/**
	 * Define Galwalking_Elementor class
	 */
	class Galwalking_Elementor {
		...
		public function register_addon( $file, $widgets_manager ) {
			...
			$class = sprintf( 'Elementor\Galwalking_%s', $class );
		...
		public function edit_scripts() {
			...
			$js_core = galwalking_theme()->get_core()->modules['cherry-js-core'];
			$ui      = galwalking_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = galwalking_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'galwalking-edit', 'galwalkingEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'galwalking' ) ) {
					continue;
				}
...
/**
 * Returns instance of Galwalking_Elementor
 *
 * @return object
 */
function galwalking_elementor() {
	return Galwalking_Elementor::get_instance();
}

galwalking_elementor();
