...
if ( ! class_exists( 'Galwalking_Custom_Posts_Widget' ) ) {

	/**
	 * Class Galwalking_Custom_Posts_Widget.
	 */
	class Galwalking_Custom_Posts_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Custom Posts', 'galwalking' );
			$this->widget_description = esc_html__( 'Display custom posts your site.', 'galwalking' );
			$this->widget_id          = apply_filters( 'galwalking_custom_posts_widget_ID', 'galwalking-widget-custom-posts' );
			$this->widget_cssclass    = apply_filters( 'galwalking_custom_posts_widget_cssclass', 'widget-custom-posts custom-posts' );
			$this->utility            = galwalking_utility()->utility;
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Recent posts', 'galwalking' ),
				...
				'terms_type' => array(
					...
					'options' => array(
						'category_name' => array(
							'label' => esc_html__( 'Category', 'galwalking' ),
							'slave' => 'terms_type_post_category',
						),
						'tag'           => array(
							'label' => esc_html__( 'Tag', 'galwalking' ),
							'slave' => 'terms_type_post_tag',
						),
						'post_format'   => array(
							'label' => esc_html__( 'Post Format', 'galwalking' ),
							'slave' => 'terms_type_post_format',
						),
					),
					'label'   => esc_html__( 'Choose taxonomy type', 'galwalking' ),
				),
				'category_name' => array(
					'type'             => 'select',
					'size'             => 1,
					...
					'options'          => false,
					'label'            => esc_html__( 'Select category', 'galwalking' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select category', 'galwalking' ),
				...
				'tag' => array(
					...
					'options'          => false,
					'label'            => esc_html__( 'Select tags', 'galwalking' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select tags', 'galwalking' ),
				...
				'post_format' => array(
					...
					'options'          => false,
					'label'            => esc_html__( 'Select post format', 'galwalking' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select post format', 'galwalking' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 0,
					'label'     => esc_html__( 'Posts count ( Set 0 to show all. )', 'galwalking' ),
				),
				'post_offset' => array(
					'type'       => 'stepper',
					'value'      => '0',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Offset post', 'galwalking' ),
				),
				'title_length' => array(
					'type'       => 'stepper',
					'value'      => '10',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Title words length ( Set 0 to hide title. )', 'galwalking' ),
				),
				'excerpt_length' => array(
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Excerpt words length ( Set 0 to hide excerpt. )', 'galwalking' ),
				),
				'meta_data' => array(
					'type'    => 'checkbox',
					'value'   => array(
					...
					'options' => array(
						'date'          => esc_html__( 'Date', 'galwalking' ),
						'author'        => esc_html__( 'Author', 'galwalking' ),
						'comment_count' => esc_html__( 'Comment count', 'galwalking' ),
						'category'      => esc_html__( 'Category', 'galwalking' ),
						'post_tag'      => esc_html__( 'Tag', 'galwalking' ),
						'more_button'   => esc_html__( 'More Button', 'galwalking' ),
					),
					'label'   => esc_html__( 'Display post meta data', 'galwalking' ),
				),
				'button_text' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Read More', 'galwalking' ),
					'label' => esc_html__( 'Post read more button label', 'galwalking' ),
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			$template = galwalking_get_locate_template( 'inc/widgets/custom-posts/views/custom-post-view.php' );
			...
			$footer_columns = get_theme_mod( 'footer_widget_columns', galwalking_theme()->customizer->get_default( 'footer_widget_columns' ) );
			...
			$img_size_array = array(
				'default'      => 'galwalking-thumb-130-125',
				'sidebar'      => 'galwalking-thumb-72-62',
				'sidebar-shop' => 'galwalking-thumb-72-62',
				'footer-area'  => ( '1' !== $footer_columns ) ? 'galwalking-thumb-72-62' : 'galwalking-thumb-130-125',
			);
			...
			if ( $posts ) {
				...
				foreach ( $posts as $post ) {
					...
					$author = $this->utility->meta_data->get_author( array(
						...
						'prefix'  => esc_html__( 'by ', 'galwalking' ),
	...
	add_action( 'widgets_init', 'galwalking_register_custom_posts_widget' );
	/**
	 * Register custom-posts widget.
	 */
	function galwalking_register_custom_posts_widget() {
		register_widget( 'Galwalking_Custom_Posts_Widget' );
	}
}
