...
if ( ! class_exists( 'Galwalking_Widget_Area' ) ) {

	/**
	 * Class Galwalking_Widget_Area.
	 */
	class Galwalking_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'galwalking_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'galwalking_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'galwalking_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function galwalking_widget_area() {
		return Galwalking_Widget_Area::get_instance();
	}

	galwalking_widget_area();
}
