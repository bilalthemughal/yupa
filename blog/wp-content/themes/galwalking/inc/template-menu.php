 ...
 * @return string
 */
function galwalking_get_main_menu() {
	$args = apply_filters( 'galwalking_main_menu_args', array(
		'theme_location'   => 'main',
		'container'        => '',
		'menu_id'          => 'main-menu',
		'echo'             => false,
		'fallback_cb'      => 'galwalking_set_nav_menu',
		'fallback_message' => esc_html__( 'Set main menu', 'galwalking' ),
	) );
 ...
 * @return void
 */
function galwalking_main_menu() {

	$main_menu = galwalking_get_main_menu();
	$menu_btn  = galwalking_get_menu_toggle();
 ...
 * @return void
 */
function galwalking_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', galwalking_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}

	$args = apply_filters( 'galwalking_footer_menu_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'galwalking_set_nav_menu',
		'fallback_message' => esc_html__( 'Set footer menu', 'galwalking' ),
	) );
 ...
 * @return void
 */
function galwalking_top_menu() {
	
	if ( ! galwalking_is_top_menu_visible() ) {
		return;
	}

	wp_nav_menu( apply_filters( 'galwalking_top_menu_args', array(
		'theme_location'  => 'top',
		'container'       => 'div',
 ...
 * @return bool
 */
function galwalking_is_top_menu_visible() {

	$is_visible = false;

	if ( has_nav_menu( 'top' ) && get_theme_mod( 'top_menu_visibility', galwalking_theme()->customizer->get_default( 'top_menu_visibility' ) ) ) {
		$is_visible = true;
	}
 ...
 * @return string
 */
function galwalking_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'galwalking_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'galwalking_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'galwalking' ),
	), $context, $type );
 ...
 * @return null|string
 */
function galwalking_set_nav_menu( $args ) {
 ...
 * @return string
 */
function galwalking_get_menu_toggle() {
	$format = apply_filters(
		'galwalking_menu_toggle_html',
