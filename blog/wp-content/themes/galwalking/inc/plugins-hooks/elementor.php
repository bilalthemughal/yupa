...
// Set theme icon.
add_action( 'elementor/controls/controls_registered', 'galwalking_add_theme_icons_to_icon_control', 20 );
add_action( 'elementor/editor/after_enqueue_styles', 'galwalking_enqueue_icon_font' );

// Modify default values into widgets.
add_action( 'elementor/element/before_section_end', 'galwalking_modify_default_values_widgets', 10, 3 );

// Add additional controls into tabs widget.
add_action( 'elementor/element/tabs/section_tabs_style/before_section_end', 'galwalking_add_tabs_additional_controls', 10, 2 );

// Add column additional classes.
add_action( 'elementor/frontend/element/before_render', 'galwalking_add_column_additional_classes' );

// Add multi columns settings into text-editor widget.
add_action( 'elementor/element/text-editor/section_style/before_section_end', 'galwalking_add_columns_to_text_editor', 10, 2 );

// Add additional classes into social-icons widget.
add_action( 'elementor/element/social-icons/section_social_style/before_section_end', 'galwalking_social_icons_additional_classes', 10, 2 );

// Modify jet-posts atts.
add_filter( 'jet-elements/shortcodes/jet-posts/atts', 'galwalking_modify_jet_posts_atts' );

// Add additional styling option into jet-post widget.
add_action( 'elementor/element/jet-posts/section_excerpt_style/before_section_start', 'galwalking_jet_posts_additional_style_options', 10, 2 );

// FIX Responsive Custom Column Width Bug on tablet.
add_action( 'elementor/element/column/layout/before_section_end', 'galwalking_fix_responsive_column_width_bug', 10, 2 );

// UPD column typography heading selectors.
add_action( 'elementor/element/column/section_typo/before_section_end', 'galwalking_update_column_typog_heading_selectors', 10, 2 );

// Modify content container type into elementor library page.
add_filter( 'theme_mod_content_container_type', 'galwalking_elementor_library_content_container_type' );

// Modify video widget.
add_action( 'elementor/element/video/section_video_style/before_section_end', 'galwalking_modify_elementor_video_widget', 10, 2 );

// Modify progress bar widget.
add_action( 'elementor/element/progress/section_progress_style/before_section_end', 'galwalking_add_controls_to_section_progress_style', 10, 2 );
add_action( 'elementor/element/progress/section_title/after_section_end', 'galwalking_add_section_progress_percentage_style', 10, 2 );

// Modify wp widget arguments.
add_filter( 'elementor/widgets/wordpress/widget_args', 'galwalking_modify_elementor_wp_widget_args', 10, 2 );

// Modify countdown timer widget.
add_action( 'elementor/element/jet-countdown-timer/section_label_styles/before_section_end', 'galwalking_countdown_timer_additional_control', 10, 2 );

// Modify accordion widget.
add_action( 'elementor/element/accordion/section_title_style/before_section_end', 'galwalking_modify_accordion_widget', 10, 2 );
 ...
 */
function galwalking_add_theme_icons_to_icon_control( $controls_manager ) {
 ...
 * Enqueue icon font.
 */
function galwalking_enqueue_icon_font() {
	wp_enqueue_style( 'iconsmind', GALWALKING_THEME_CSS . '/iconsmind.min.css', array(), '1.0.0' );
}
 ...
 */
function galwalking_modify_default_values_widgets( $element, $section_id, $args ) {

	$grey_color    = get_theme_mod( 'grey_color_1', galwalking_theme()->customizer->get_default( 'grey_color_1' ) );
	$primary_color = get_theme_mod( 'regular_accent_color_1', galwalking_theme()->customizer->get_default( 'regular_accent_color_1' ) );
 ...
 */
function galwalking_add_tabs_additional_controls( $widget, $args ) {
	...
	$widget->add_control(
		'tab_hover_color',
		array(
			'label' => esc_html__( 'Hover Color', 'galwalking' ),
	...
	$widget->add_control(
		'tab_title_bg',
		array(
			'label'     => esc_html__( 'Background Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_control(
		'tab_title_hover_bg',
		array(
			'label'     => esc_html__( 'Hover Background Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_control(
		'tab_title_active_bg',
		array(
			'label'     => esc_html__( 'Active Background Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_responsive_control(
		'tab_content_padding',
		array(
			'label'      => esc_html__( 'Content Padding', 'galwalking' ),
 ...
 */
function galwalking_add_column_additional_classes( \Elementor\Element_Base $element ) {
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_add_columns_to_text_editor( $widget, $args ) {

	$widget->add_control(
		'multi_columns',
		array(
			'label'              => esc_html__( 'Multi Columns Layout', 'galwalking' ),
			'type'               => Elementor\Controls_Manager::SWITCHER,
			'label_off'          => esc_html__( 'Off', 'galwalking' ),
			'label_on'           => esc_html__( 'On', 'galwalking' ),
	...
	$widget->add_responsive_control(
		'multi_columns_count',
		array(
			'label'     => esc_html__( 'Columns Count', 'galwalking' ),
	...
	$widget->add_responsive_control(
		'multi_columns_gap',
		array(
			'label'     => esc_html__( 'Gap Between Columns', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::SLIDER,
			'default'   => array(
				'size' => 30,
			),
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_social_icons_additional_classes( $widget, $args ) {
	$widget->update_control(
		'icon_color',
		array(
 ...
 * @return array
 */
function galwalking_modify_jet_posts_atts( $atts = array() ) {

	$new_atts = array(
		'avatar_size' => array(
			'type'      => 'number',
			'label'     => esc_html__( 'Avatar Size', 'galwalking' ),
			'default'   => 50,
			'min'       => 30,
			'max'       => 100,
			'step'      => 1,
	...
	$new_atts_2 = array(
		'show_category' => array(
			'type'         => 'switcher',
			'label'        => esc_html__( 'Show Categories', 'galwalking' ),
			'label_on'     => esc_html__( 'Yes', 'galwalking' ),
			'label_off'    => esc_html__( 'No', 'galwalking' ),
			'return_value' => 'yes',
			'default'      => '',
			'condition'    => array(
				'show_meta' => array( 'yes' ),
		...
		'badge' => array(
			'type'         => 'switcher',
			'label'        => esc_html__( 'Badge', 'galwalking' ),
			'label_on'     => esc_html__( 'Yes', 'galwalking' ),
			'label_off'    => esc_html__( 'No', 'galwalking' ),
			'return_value' => 'yes',
			'default'      => '',
		...
		'badge_tax' => array(
			'type'      => 'select',
			'label'     => esc_html__( 'Badge Taxonomy', 'galwalking' ),
			'options'   => array(
				'category' => esc_html__( 'Categories', 'galwalking' ),
				'post_tag' => esc_html__( 'Tags', 'galwalking' ),
			),
			'default'   => 'post_tag',
			'condition' => array(
				'badge' => array( 'yes' ),
	...
	$atts = galwalking_array_merge_after_key( $atts, $new_atts, 'show_author' );
	$atts = galwalking_array_merge_after_key( $atts, $new_atts_2, 'show_comments' );
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_jet_posts_additional_style_options( $widget, $args ) {
	...
	$widget->start_controls_section(
		...
		array(
			'label'      => esc_html__( 'Author Block', 'galwalking' ),
	...
	$widget->add_control(
		'author_color',
		array(
			'label'     => esc_html__( 'Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_control(
		'author_link_color',
		array(
			'label'     => esc_html__( 'Link Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_control(
		...
		array(
			'label'     => esc_html__( 'Link Hover Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_group_control(
		...
		array(
			...
			'label'    => esc_html__( 'Typography', 'galwalking' ),
	...
	$widget->add_responsive_control(
		'author_padding',
		array(
			'label'      => esc_html__( 'Padding', 'galwalking' ),
			'type'       => Elementor\Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
	...
	$widget->add_responsive_control(
		'author_margin',
		array(
			'label'      => esc_html__( 'Margin', 'galwalking' ),
			'type'       => Elementor\Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
	...
	$widget->add_control(
		'badge_spacing',
		array(
			'label'     => esc_html__( 'Spacing', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::SLIDER,
			'range'     => array(
				'px' => array(
					'max' => 50,
	...
	$widget->start_controls_tab(
		'tab_badge_normal',
		array(
			'label' => esc_html__( 'Normal', 'galwalking' ),
		)
	);
	...
	$widget->add_control(
		'badge_color',
		array(
			'label' => esc_html__( 'Text Color', 'galwalking' ),
			'type' => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_responsive_control(
		'badge_border_radius',
		array(
			'label'      => esc_html__( 'Border Radius', 'galwalking' ),
			'type'       => Elementor\Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%' ),
			'selectors'  => array(
	...
	$widget->add_group_control(
		...
		array(
			'name'     => 'badge_border',
			'label'    => esc_html__( 'Border', 'galwalking' ),
			'selector' => '{{WRAPPER}} ' . $css_selectors['badge-link'],
		)
	);
	...
	$widget->start_controls_tab(
		'tab_badge_hover',
		array(
			'label' => esc_html__( 'Hover', 'galwalking' ),
		)
	);
 ...
 * @param array  $args    Element arguments.
 */
function galwalking_fix_responsive_column_width_bug( $element, $args ) {
 ...
 * @param array  $args    Element arguments.
 */
function galwalking_update_column_typog_heading_selectors( $element, $args ) {
 ...
 * @return string
 */
function galwalking_elementor_library_content_container_type( $value ) {
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_modify_elementor_video_widget( $widget, $args ) {
	$widget->update_control(
		'play_icon_size',
		array(
			'selectors' => array(
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_add_controls_to_section_progress_style( $widget, $args ) {
	...
	$widget->update_control(
		'bar_bg_color',
		array(
			'label'     => esc_html__( 'Wrapper Background Color', 'galwalking' ),
			'separator' => 'before',
		)
	);
	...
	$widget->update_control(
		...
		array(
			'label' => esc_html__( 'Inner Text Typography', 'galwalking' ),
		)
	);
	...
	$widget->add_responsive_control(
		'bar_wrapper_padding',
		array(
			'label'      => esc_html__( 'Wrapper Padding', 'galwalking' ),
			'type'       => Elementor\Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
	...
	$widget->add_responsive_control(
		...
		array(
			'label'      => esc_html__( 'Wrapper Border Radius', 'galwalking' ),
			'type'       => Elementor\Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%' ),
			'selectors'  => array(
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_add_section_progress_percentage_style( $widget, $args ) {

	$widget->start_controls_section(
		'section_percentage_style',
		array(
			'label'      => esc_html__( 'Percentage Style', 'galwalking' ),
			'tab'        => Elementor\Controls_Manager::TAB_STYLE,
			'show_label' => false,
			'condition'  => array(
	...
	$widget->add_control(
		...
		array(
			'label'     => esc_html__( 'Percentage Color', 'galwalking' ),
			'type'      => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_group_control(
		...
		array(
			...
			'label'     => esc_html__( 'Percentage Typography', 'galwalking' ),
 ...
 * @return array
 */
function galwalking_modify_elementor_wp_widget_args( $widget_args, $widget ) {
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_countdown_timer_additional_control( $widget, $args ) {

	$widget->add_responsive_control(
		'label_alignment',
		array(
			'label'   => esc_html__( 'Alignment', 'galwalking' ),
			'type'    => Elementor\Controls_Manager::CHOOSE,
			'options' => array(
				'left'    => array(
					'title' => esc_html__( 'Left', 'galwalking' ),
					'icon'  => 'fa fa-align-left',
				),
				'center' => array(
					'title' => esc_html__( 'Center', 'galwalking' ),
					'icon'  => 'fa fa-align-center',
				),
				'right' => array(
					'title' => esc_html__( 'Right', 'galwalking' ),
 ...
 * @param array  $args   Widget arguments.
 */
function galwalking_modify_accordion_widget ( $widget, $args ) {

	$widget->add_control(
		'title_hover_background',
		array(
			'label' => esc_html__( 'Hover Background', 'galwalking' ),
			'type' => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
	...
	$widget->add_control(
		...
		array(
			'label' => esc_html__( 'Active Background', 'galwalking' ),
			'type' => Elementor\Controls_Manager::COLOR,
			'selectors' => array(
