...
if ( have_posts() ) :
	...
	if ( is_home() && ! is_front_page() ) : ?>
		<header>
			<?php printf( apply_filters( 'galwalking_single_post_title_html', '<h1 class="page-title screen-reader-text">%s</h1>' ), single_post_title( null, false ) ); ?>
		</header>
	...
	<?php galwalking_ads_home_before_loop() ?>
