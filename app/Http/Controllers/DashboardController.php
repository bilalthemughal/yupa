...
class DashboardController extends Controller {
	...
	public function user_kit(Request $request) {
		...
		$user_id = Auth::user()->id;
		$confirmKit = ConfirmKit::where('user_id', $user_id)->latest()->get();
	...
	//kit with pack
	public function kit_withpack(Request $request) {
		$secret = $request->secret;
		...
		return view('fontend.kit_withpack', compact('phones', 'medicals', 'toiletries', 'others', 'userpackege'));
	}
