...
<div class="col-md-6">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.hotel.booking')}}">View-></a>
		</div>
	</div>
</div>
...
<div class="col-md-6">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h6 class="panel-title">Booking Package</h6>
			<div class="heading-elements">
				<ul class="icons-list">
            		<li><a data-action="collapse"></a></li>
            		<li><a data-action="reload"></a></li>
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.packege.getbooking')}}">View-></a>
		</div>
	</div>
</div>
</div>
...
<div class="col-md-6">
	<div class="panel panel-danger">
		<div class="panel-heading">
			<h6 class="panel-title">Total Package</h6>
			<div class="heading-elements">
				<ul class="icons-list">
            		<li><a data-action="collapse"></a></li>
            		<li><a data-action="reload"></a></li>
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.packege')}}">View-></a>
		</div>
	</div>
</div>
...
<div class="col-md-6">
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.hotel')}}">View-></a>
		</div>
	</div>
</div>
</div>
...
<div class="col-md-6">
	<div class="panel panel-warning">
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.travelar')}}">View-></a>
		</div>
	</div>
</div>
...
<div class="col-md-6">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<a href="{{route('admin.destination')}}">View-></a>
		</div>
	</div>
</div>
</div>
