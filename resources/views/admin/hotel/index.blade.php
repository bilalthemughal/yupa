...
<div class="panel panel-flat">
    ...
    <div class="panel-heading">
        ...
        <a href="{{ route('admin.hotel.create') }}" class="btn btn-info"><i class="icon-stack-plus mr-2"></i>Create</a>
                ...
                <tbody id="product_list">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('admin.hotel.changeStatus', [$element->id, 0])}}" class="btn btn-xs btn-success">Active</a>

                            @else

                            <a href="{{route('admin.hotel.changeStatus', [$element->id, 1])}}" class="btn btn-xs btn-danger">In Active</a>
