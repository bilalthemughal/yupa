     ...
     <div class="panel panel-flat">
              ...
              <div class="panel-body">
                 <form role="form" action="{{ route('admin.packege.update',$packege->id) }}" method="post" enctype="multipart/form-data" id="editForm">
                     ...
                     <div class="row">
                       <legend class="text-bold">Package (Option 1):
                      ...
                      <div class="row">
                       <legend class="text-bold">Package (Option 2):
                    ...
                    <button type="submit" class="btn btn-primary"  id="submit">Update Package<i class="icon-arrow-right14 position-right"></i></button>
