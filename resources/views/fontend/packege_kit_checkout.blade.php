  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row bg-payment">
        <div id="content12">
          <form action="{{ route('checkout_form', ['secret' => $check->secret]) }}" method="post">
            @csrf
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="row">
                    <div class="col-md-12 booking-price-container">
                      ...
                      <div class="col-md-12" style="padding-bottom: 20px;">
                        <label>{{$check->packege->name}} ({{$check->type}}) - Price RM{{ number_format($check->total, 2) }}</label>
                      </div>
                      ...
                      <div class="col-md-6" style="padding-bottom: 5px;">
                        <span class="depart-date-details" style="float: left;">{{$element->name}}</span>
                      </div>
                      <div class="col-md-6" style="padding-bottom: 5px;">
                        <span class="return-date-details" style="float: right;">{{$element->time}}</span>
                      </div>
                      @endforeach
                      @if ($check->bookkit->count() > 0)

                      <div class="row"  style="margin-top: 10px; padding-bottom: 5px;">
                        <div class="col-md-12" style="">
                          <h4><span class="badge badge-sm badge-info">Booking Kit</span></h4>
                        </div>

                      @foreach ($check->bookkit as $element)
                      <div class="col-md-6" style="padding-bottom: 5px;">
                        <span class="depart-date-details" style="float: left;">{{$element->tarvelkit->name}} ({{  $element->quantity }})</span>
                      </div>
                      <div class="col-md-6" style="padding-bottom: 5px;">
                        <span class="return-date-details" style="float: right;">{{ number_format($element->price * $element->quantity, 2) }}</span>
                      </div>
                      @endforeach
                      </div>
                      @endif
                      ...
                      <div class="col-md-12" style="padding-bottom: 10px;">
                        <div class="order-total-prices">
                          ...
                          <span id="total-price" class="align-right-col flt-right">{{ number_format($check->total + $check->kit_price, 2) }}</span>
                        </div>
                      </div>
                      <div class="col-md-12" style="padding-bottom: 10px;">
