...
@section('page-header')
<!-- <div class="reg">
	<img src="{{asset('/storage/hotel/banner/'.$hotel->banner)}}" class="bg4"/ width="100%" height="auto">
</div> -->
<div class="bg2 overlay" style="background-image: url({{asset('/storage/hotel/banner/'.$hotel->banner)}});">
    <div class="container">
        <div class="row">
