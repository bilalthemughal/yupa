...
@section('procontent')
    ...
    <img src="{{asset('/storage/packege/banner/'.$packege->packege->banner)}}" alt="" class="img-responsive">
     ...
     <div>
        ...
        <div>
         ...
         @if ($packege->bookkit->count()>0)
            <h4 class="label label-info">Booking Kit</h4>
            <table class="table table-bordered">
              ...
              @foreach($packege->bookkit as $kit)
                <tr>
         ...
         <h3>Your Tour Status @if ($packege->status==0)
             ...
             <a href="{{ route('checkout_form', ['secret' => $packege->secret]) }}"><span class="label label-success">Checkout</span></a>
             @else
     ...
     <div class="row">
        ...
        @php
            $user_review = $packege->packege->reviews->where('user_id', auth()->user()->id)->where('status', 'approved');
        @endphp
        <div class="col-md-12">
        <table class="table table-bordered">
            <thead>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('package.review.store') }}" id="review_form">
                {{ csrf_field() }}
                ...
                <div class="row" id="textarea" style="display: none;">
                    <div class="col-md-12" style="padding-bottom: 10px;">
                        ...
                        <input type="hidden" name="pakcage_id" id="pakcage_id" value="{{ $packege->packege->id }}">
