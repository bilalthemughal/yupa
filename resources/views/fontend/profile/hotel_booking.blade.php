            ...
            <div class="col-lg-4 col-md-6 borderimg1">
                ...
                <div class="darkbg3" style="width: 225px;">
                    ...
                    <div class="row">
                        ...
                        <h6>Hotel Location : {{$hotel_booking->hotel->entire_place}}</h6>
                        <h6>Booking Date : {{$hotel_booking->created_at->format('Y/m/d')}}</h6>
                        <h6>Status : {{$hotel_booking->status == '0' ? 'Peding' : 'Approved' }}</h6>
