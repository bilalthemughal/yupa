                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="padding-bottom: 20px;">
                                            ...
                                            <input type="date" class="form-control form-control100" name="pick_up_date" min="{{date('Y-m-d')}}"/ value="{{old('pick_up_date')}}">
                                        ...
                                        <div class="col-md-4" style="padding-bottom: 20px;">
                                            ...
                                            <input type="time" class="form-control form-control100" name="pick_up_time" value="{{old('pick_up_time')}}" />

                                             @if ($errors->has('pick_up_time'))

                                            <span class="text-danger">{{ $errors->first('pick_up_time') }}</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="padding-bottom: 20px;">
                                            ...
                                            <input type="text" class="form-control form-control100" name="location_name" placeholder="Example: Hotel's Name or Airport's Name"  value="{{old('location_name')}}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a id="phone-access" class="btn travel-kits-favourite" onclick="chooseCategory('phone-access')">Phone Accs</a>
                                    ...
                                    <td class="col-chk" style="padding-right: 5px;"><input type="checkbox" id="pha{{$p+1}}" class="chk-travel-kits" name="pha[]" value="{{$phn->id}}" /></td>



                                    <td class="col-name"><span id="name-pha{{$p+1}}">{{$phn->name}}</span></td>

                                    <td style="text-align: right;"><strong style="color: #40b8dc;"><span style="font-size: 12px; color: #999;">MYR </span><span style="font-size: 16px;" id="price-pha{{$p+1}}">{{$phn->price}}</span></strong>



                                    <input type="hidden" name="price[]" value="{{$phn->price}}"></td>
