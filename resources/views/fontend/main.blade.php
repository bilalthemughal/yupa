			...
			<div class="row">
				<div class="col-md-4 box-left-border">
					<div class="featured-icon">
						<img src="https://yupa.asia/public/fontend/images/beach.png">
					</div>
					<div class="featured-title">
						<h4 class="h41">See the best of the world</h4>
						<p class="p1" style="font-size: 13px;">Make sure you don't miss out any attractive hotspot nearby your destination</p>
					</div>
				</div>
				<div class="col-md-4 box-left-border">
					<div class="featured-icon">
						<img src="https://yupa.asia/public/fontend/images/calendar.png">
					</div>
					<div class="featured-title">
						<h4 class="h41">Keep up with your schedule</h4>
						<p class="p1" style="font-size: 13px;">Get to know when to depart so you won't miss out what you've planned</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="featured-icon">
						<img src="https://yupa.asia/public/fontend/images/tourist.png">
					</div>
					<div class="featured-title">
						<h4 class="h41">Find a travel buddy</h4>
						<p class="p1" style="font-size: 13px;">Get match with a friendly companion to travel together</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="content4">
		<div class="container">
			<div class="row headercontent">
				<div class="col-md-12">
					<h4><b>Suggest for you</b></h4>
				</div>
				<div class="col-md-10">
					<p class="p1">Recent best tour packages designed for your journey</p>
				</div>
				<div class="col-md-2">
	...
	<div id="content6">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10">
					<p class="p1">Make sure you don't miss out any homestays nearby your destination</p>
				</div>
				<div class="col-md-2">
					<p class="p1"><a class="views-all-btn flt-right" href="{{ route('hotel.index') }}">View All ></a></p>
				</div>
				@foreach($data['hotel'] as $hotel)
				<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 borderimg1">
					...
					<div class="darkbg3">
						...
						<div class="row">
							...
							<div class="col-md-6 price1"><span class="currency">MYR</span> {{ $hotel->price }}</div>
						</div>
					</div>
...
<section>
	<div id="content7">
		<div class="container">
			<div class="row">
				<div class="col-md-12 headercontent">
					<h4><b>Latest Travel Promotions</b></h4>
					<div>
					<p class="p1">Make sure you don't miss out any promotions for your trip</p>
				</div>
				</div>
				<div class="col-md-12">
					<center>
					<div class="bg4" style="margin-bottom: 25px;">
						<img src="{{asset('fontend/images/travel.jpg')}}" class="bg4"/>
				...
				<div class="col-lg-4 col-md-4">
					<center>
					<div class="bg4" style="margin-bottom: 25px;">
						<img src="{{asset('fontend/images/bg3.jpg')}}" class="bg4"/>
						<div class="top-right titleimg5"><p>Promotion</p><p>10%</p></div>
					</div>
					</center>
				</div> -->
