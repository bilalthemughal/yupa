                ...
                <div class="col-md-12 booking-price-container">
                  ...
                  <div class="col-md-12" style="padding-bottom: 10px;">
                    <div class="order-total-prices">
                      <span>Total</span>
                      <input type="hidden" name="price" value="{{$check->total_price}}">
                      <span id="total-price" class="align-right-col flt-right">RM {{$check->total_price}}</span>({{$check->price}} x {{$check->night}})
                    </div>
                  </div>
                  <div class="col-md-12" style="padding-bottom: 10px;">
